...
// 2025/26 Modern Teams (Modo Atual - 14 Teams, 154 Players)
addTeam("Real Madrid 2025/26", [
  ["Thibaut Courtois", "GOL", 90], ["Dani Carvajal", "DEF", 87], ["Éder Militão", "DEF", 85],
  ["Antonio Rüdiger", "DEF", 87], ["Ferland Mendy", "DEF", 84], ["Federico Valverde", "MEI", 89],
  ["Aurélien Tchouaméni", "MEI", 85], ["Jude Bellingham", "MEI", 91], ["Rodrygo Goes", "ATA", 86],
  ["Kylian Mbappé", "ATA", 93], ["Vinícius Júnior", "ATA", 92]
]);

addTeam("Barcelona 2025/26", [
  ["Marc-André Ter Stegen", "GOL", 88], ["Jules Koundé", "DEF", 85], ["Ronald Araújo", "DEF", 86],
  ["Pau Cubarsí", "DEF", 82], ["Alejandro Balde", "DEF", 83], ["Pedri González", "MEI", 88],
  ["Pablo Gavi", "MEI", 86], ["Dani Olmo", "MEI", 86], ["Lamine Yamal", "ATA", 89],
  ["Robert Lewandowski", "ATA", 90], ["Raphinha Dias", "ATA", 87]
]);

addTeam("Manchester City 2025/26", [
  ["Ederson Moraes", "GOL", 87], ["Kyle Walker", "DEF", 84], ["Rúben Dias", "DEF", 89],
  ["John Stones", "DEF", 86], ["Josko Gvardiol", "DEF", 85], ["Rodri Hernández", "MEI", 92],
  ["Kevin De Bruyne", "MEI", 91], ["Phil Foden", "MEI", 89], ["Bernardo Silva", "MEI", 88],
  ["Erling Haaland", "ATA", 93], ["Jeremy Doku", "ATA", 84]
]);

addTeam("Bayern Munique 2025/26", [
  ["Manuel Neuer", "GOL", 86], ["Joshua Kimmich", "DEF", 87], ["Dayot Upamecano", "DEF", 84],
  ["Kim Min-jae", "DEF", 85], ["Alphonso Davies", "DEF", 85], ["João Palhinha", "MEI", 85],
  ["Leon Goretzka", "MEI", 83], ["Jamal Musiala", "MEI", 88], ["Leroy Sané", "ATA", 84],
  ["Serge Gnabry", "ATA", 83], ["Harry Kane", "ATA", 91]
]);

addTeam("Arsenal 2025/26", [
  ["David Raya", "GOL", 85], ["Ben White", "DEF", 84], ["William Saliba", "DEF", 88],
  ["Gabriel Magalhães", "DEF", 86], ["Jurrien Timber", "DEF", 82], ["Declan Rice", "MEI", 88],
  ["Martin Ødegaard", "MEI", 89], ["Mikel Merino", "MEI", 84], ["Bukayo Saka", "ATA", 89],
  ["Kai Havertz", "ATA", 85], ["Gabriel Martinelli", "ATA", 84]
]);

addTeam("Liverpool 2025/26", [
  ["Alisson Becker", "GOL", 89], ["Trent Alexander-Arnold", "DEF", 86], ["Ibrahima Konaté", "DEF", 85],
  ["Virgil van Dijk", "DEF", 90], ["Andrew Robertson", "DEF", 84], ["Ryan Gravenberch", "MEI", 84],
  ["Alexis Mac Allister", "MEI", 86], ["Dominik Szoboszlai", "MEI", 85], ["Mohamed Salah", "ATA", 90],
  ["Diogo Jota", "ATA", 85], ["Luis Díaz", "ATA", 86]
]);

addTeam("Inter de Milão 2025/26", [
  ["Yann Sommer", "GOL", 85], ["Benjamin Pavard", "DEF", 84], ["Francesco Acerbi", "DEF", 83],
  ["Alessandro Bastoni", "DEF", 86], ["Denzel Dumfries", "DEF", 82], ["Federico Dimarco", "DEF", 85],
  ["Nicolò Barella", "MEI", 87], ["Hakan Calhanoglu", "MEI", 86], ["Henrikh Mkhitaryan", "MEI", 83],
  ["Lautaro Martínez", "ATA", 89], ["Marcus Thuram", "ATA", 85]
]);

addTeam("Milan 2025/26", [
  ["Mike Maignan", "GOL", 86], ["Davide Calabria", "DEF", 81], ["Fikayo Tomori", "DEF", 84],
  ["Strahinja Pavlovic", "DEF", 82], ["Theo Hernández", "DEF", 87], ["Youssouf Fofana", "MEI", 82],
  ["Ruben Loftus-Cheek", "MEI", 82], ["Tijjani Reijnders", "MEI", 84], ["Christian Pulisic", "ATA", 85],
  ["Alvaro Morata", "ATA", 85], ["Rafael Leão", "ATA", 88]
]);

addTeam("Juventus 2025/26", [
  ["Michele Di Gregorio", "GOL", 83], ["Pierre Kalulu", "DEF", 81], ["Federico Gatti", "DEF", 82],
  ["Gleison Bremer", "DEF", 86], ["Andrea Cambiaso", "DEF", 83], ["Manuel Locatelli", "MEI", 83],
  ["Douglas Luiz", "MEI", 84], ["Teun Koopmeiners", "MEI", 86], ["Nico González", "ATA", 82],
  ["Kenan Yildiz", "ATA", 84], ["Dusan Vlahovic", "ATA", 86]
]);

addTeam("Paris Saint-Germain 2025/26", [
  ["Gianluigi Donnarumma", "GOL", 88], ["Achraf Hakimi", "DEF", 85], ["Marquinhos Corrêa", "DEF", 86],
  ["Willian Pacho", "DEF", 83], ["Nuno Mendes", "DEF", 84], ["Vitinha Ferreira", "MEI", 86],
  ["João Neves", "MEI", 84], ["Warren Zaïre-Emery", "MEI", 84], ["Ousmane Dembélé", "ATA", 86],
  ["Bradley Barcola", "ATA", 85], ["Gonçalo Ramos", "ATA", 84]
]);

addTeam("Atletico de Madrid 2025/26", [
  ["Jan Oblak", "GOL", 86], ["Marcos Llorente", "DEF", 84], ["Robin Le Normand", "DEF", 84],
  ["José Giménez", "DEF", 84], ["Samuel Lino", "DEF", 83], ["Koke Resurrección", "MEI", 83],
  ["Rodrigo De Paul", "MEI", 85], ["Conor Gallagher", "MEI", 84], ["Antoine Griezmann", "MEI", 87],
  ["Alexander Sorloth", "ATA", 84], ["Julián Alvarez", "ATA", 88]
]);

addTeam("Borussia Dortmund 2025/26", [
  ["Gregor Kobel", "GOL", 86], ["Yan Couto", "DEF", 81], ["Waldemar Anton", "DEF", 83],
  ["Nico Schlotterbeck", "DEF", 84], ["Julian Ryerson", "DEF", 82], ["Emre Can", "MEI", 82],
  ["Pascal Gross", "MEI", 83], ["Marcel Sabitzer", "MEI", 84], ["Julian Brandt", "MEI", 85],
  ["Karim Adeyemi", "ATA", 83], ["Serhou Guirassy", "ATA", 85]
]);

addTeam("Bayer Leverkusen 2025/26", [
  ["Lukas Hradecky", "GOL", 84], ["Jeremie Frimpong", "DEF", 85], ["Edmond Tapsoba", "DEF", 84],
  ["Jonathan Tah", "DEF", 84], ["Piero Hincapié", "DEF", 83], ["Alejandro Grimaldo", "DEF", 86],
  ["Granit Xhaka", "MEI", 86], ["Robert Andrich", "MEI", 83], ["Florian Wirtz", "MEI", 89],
  ["Jonas Hofmann", "ATA", 82], ["Victor Boniface", "ATA", 85]
]);

addTeam("Chelsea 2025/26", [
  ["Robert Sánchez", "GOL", 82], ["Malo Gusto", "DEF", 83], ["Wesley Fofana", "DEF", 81],
  ["Levi Colwill", "DEF", 82], ["Marc Cucurella", "DEF", 83], ["Roméo Lavia", "MEI", 80],
  ["Moisés Caicedo", "MEI", 85], ["Enzo Fernández", "MEI", 85], ["Cole Palmer", "MEI", 89],
  ["Christopher Nkunku", "ATA", 85], ["Nicolas Jackson", "ATA", 84]
]);
